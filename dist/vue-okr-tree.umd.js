...
/* harmony default export */ var setPublicPath = (null);
        ...
        // CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"72ff8ab4-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/lib/vue-okr-tree/OkrTree.vue?vue&type=template&id=47af968f&
        var render = function () {
          var _vm = this; var _h = _vm.$createElement; var _c = _vm._self._c || _h; return _c('div', { staticClass: "org-chart-container" }, [_c('div', {
            ref: "orgChartRoot", staticClass: "org-chart-node-children", class: {
          ...
          }, _vm._l((_vm.root.childNodes), function (child) { return _c('OkrTreeNode', { key: _vm.getNodeKey(child), attrs: { "node": child, "root": _vm.root, "orkstyle": "", "show-collapsable": _vm.showCollapsable, "label-width": _vm.labelWidth, "label-height": _vm.labelHeight, "renderContent": _vm.renderContent, "selected-key": _vm.selectedKey, "default-expand-all": _vm.defaultExpandAll, "node-key": _vm.nodeKey, "props": _vm.props } }) }), 1)])
        }
        var staticRenderFns = []


        // CONCATENATED MODULE: ./src/lib/vue-okr-tree/OkrTree.vue?vue&type=template&id=47af968f&
        ...
        // CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"72ff8ab4-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/lib/vue-okr-tree/OkrTreeNode.vue?vue&type=template&id=6739137f&
        var OkrTreeNodevue_type_template_id_6739137f_render = function () {
          var this$1 = this;
          var _vm = this; var _h = _vm.$createElement; var _c = _vm._self._c || _h; return (_vm.node.visible) ? _c('div', {
            staticClass: "org-chart-node", class: {
              collapsed: !_vm.node.leftExpanded || !_vm.node.expanded,
              'is-leaf': _vm.isLeaf,
              'is-current': _vm.node.isCurrent,
              'is-left-child-node': _vm.isLeftChildNode,
              'is-not-child': _vm.node.level === 1 && _vm.node.childNodes.length <= 0 && _vm.leftChildNodes.length <= 0,
              'only-both-tree-node': _vm.node.level === 1 && _vm.tree.store.onlyBothTree
            }, on: { "contextmenu": function ($event) { return this$1.handleContextMenu($event); } }
          }, [_c('transition', { attrs: { "duration": _vm.animateDuration, "name": _vm.animateName } }, [(_vm.showLeftChildNode) ? _c('div', { directives: [{ name: "show", rawName: "v-show", value: (_vm.node.leftExpanded), expression: "node.leftExpanded" }], staticClass: "org-chart-node-left-children" }, _vm._l((_vm.leftChildNodes), function (child) { return _c('OkrTreeNode', { key: _vm.getNodeKey(child), attrs: { "show-collapsable": _vm.showCollapsable, "node": child, "label-width": _vm.labelWidth, "label-height": _vm.labelHeight, "renderContent": _vm.renderContent, "selected-key": _vm.selectedKey, "node-key": _vm.nodeKey, "props": _vm.props, "is-left-child-node": "" } }) }), 1) : _vm._e()]), _c('div', {
            staticClass: "org-chart-node-label", class: {
          ...
          }, [(_vm.showNodeLeftBtn && _vm.leftChildNodes.length > 0) ? _c('div', { staticClass: "org-chart-node-left-btn", class: { expanded: _vm.node.leftExpanded }, on: { "click": function ($event) { return _vm.handleBtnClick('left') } } }) : _vm._e(), _c('div', { staticClass: "org-chart-node-label-inner", class: _vm.computeLabelClass, style: (_vm.computeLabelStyle), on: { "click": _vm.handleNodeClick } }, [_c('node-content', { attrs: { "node": _vm.node } }, [_vm._t("default", [_vm._v("\n          " + _vm._s(_vm.node.label) + "\n        ")])], 2)], 1), (_vm.showNodeBtn && !_vm.isLeftChildNode) ? _c('div', { staticClass: "org-chart-node-btn", class: { expanded: _vm.node.expanded }, on: { "click": function ($event) { return _vm.handleBtnClick('right') } } }) : _vm._e()]), _c('transition', { attrs: { "duration": _vm.animateDuration, "name": _vm.animateName } }, [(!_vm.isLeftChildNode && _vm.node.childNodes && _vm.node.childNodes.length > 0) ? _c('div', { directives: [{ name: "show", rawName: "v-show", value: (_vm.node.expanded), expression: "node.expanded" }], staticClass: "org-chart-node-children" }, _vm._l((_vm.node.childNodes), function (child) { return _c('OkrTreeNode', { key: _vm.getNodeKey(child), attrs: { "show-collapsable": _vm.showCollapsable, "node": child, "label-width": _vm.labelWidth, "label-height": _vm.labelHeight, "renderContent": _vm.renderContent, "selected-key": _vm.selectedKey, "node-key": _vm.nodeKey, "props": _vm.props } }) }), 1) : _vm._e()])], 1) : _vm._e()
        }
        var OkrTreeNodevue_type_template_id_6739137f_staticRenderFns = []


        // CONCATENATED MODULE: ./src/lib/vue-okr-tree/OkrTreeNode.vue?vue&type=template&id=6739137f&
...
/* harmony default export */ var OkrTreeNodevue_type_script_lang_js_ = ({
          ...
          computed: {
            ...
            showLeftChildNode: function showLeftChildNode() {
              // console.log(this.leftChildNodes)
          ...
          methods: {
            ...
            handleBtnClick: function handleBtnClick(isLeft) {
              // console.log(this.node.childNodes,this.root.childNodes)
              isLeft = isLeft === "left";
              var store = this.tree.store; // 表示是OKR飞书模式
              var childNodes = this.node.childNodes;
              if (store.onlyBothTree) {
                if (this.root.childNodes) {
                  this.childNodesArr = this.root.childNodes
                }
                // console.log(this.childNodesArr,'111111')
                for (let i = 0; i < this.childNodesArr.length; i++) {
                  if (this.node !== this.childNodesArr[i]) {
                    // if (isLeft) {
                      this.childNodesArr[i].leftExpanded = false
                    // }else {
                      this.childNodesArr[i].expanded = false
                    // }
                  }
                }
                this.childNodesArr = childNodes;
                // console.log(this.childNodesArr,'2222')
                if (isLeft) {
...
// CONCATENATED MODULE: ./src/lib/vue-okr-tree/OkrTreeNode.vue?vue&type=script&lang=js&
 /* harmony default export */ var vue_okr_tree_OkrTreeNodevue_type_script_lang_js_ = (OkrTreeNodevue_type_script_lang_js_);
        ...
        var component = normalizeComponent(
          ...
          OkrTreeNodevue_type_template_id_6739137f_render,
          OkrTreeNodevue_type_template_id_6739137f_staticRenderFns,
          false,
          null,
          null,
          null
...
/* harmony default export */ var merge = (function (target) {
        ...
        var node_Node = /*#__PURE__*/function () {
          ...
          function Node(options) {
            ...
            if (this.leftData) {
              this.setData(this.leftData, isLeftChild);
              ...
              if (this.leftData) {
                ...
                if (this.isLeftChilds) {
                  for (let i = 0; i < this.root.childNodes.length; i++) {
                    this.root.childNodes[i].leftChildNodes = this.isLeftChilds.childNodes[i].childNodes;
                    this.root.childNodes[i].leftExpanded = this.isLeftChilds.childNodes[i].leftExpanded;
                  }
                }
              }
            }
...
/* harmony default export */ var OkrTreevue_type_script_lang_js_ = ({
          ...
          methods: {
            ...
            nodeReset: function nodeReset(node) {
...
//# sourceMappingURL=vue-okr-tree.umd.js.map